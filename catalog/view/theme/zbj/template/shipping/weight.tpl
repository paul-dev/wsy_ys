                                        ...
                                        <div class="tab-pane" id="tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <br/>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">续重：</span><input type="text" placeholder="kg" name="weight_express_<?php echo $geo_zone['geo_zone_id']; ?>_next_weight" value="<?php echo ${'weight_express_' . $geo_zone['geo_zone_id'] . '_next_weight'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">价格：</span><input type="text" name="weight_express_<?php echo $geo_zone['geo_zone_id']; ?>_next_price" value="<?php echo ${'weight_express_' . $geo_zone['geo_zone_id'] . '_next_price'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <br/>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">续重：</span><input type="text" placeholder="kg" name="weight_postage_<?php echo $geo_zone['geo_zone_id']; ?>_next_weight" value="<?php echo ${'weight_postage_' . $geo_zone['geo_zone_id'] . '_next_weight'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">价格：</span><input type="text" name="weight_postage_<?php echo $geo_zone['geo_zone_id']; ?>_next_price" value="<?php echo ${'weight_postage_' . $geo_zone['geo_zone_id'] . '_next_price'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <br/>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">续重：</span><input type="text" placeholder="kg" name="weight_ems_<?php echo $geo_zone['geo_zone_id']; ?>_next_weight" value="<?php echo ${'weight_ems_' . $geo_zone['geo_zone_id'] . '_next_weight'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">价格：</span><input type="text" name="weight_ems_<?php echo $geo_zone['geo_zone_id']; ?>_next_price" value="<?php echo ${'weight_ems_' . $geo_zone['geo_zone_id'] . '_next_price'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" data-rowid="<?php echo $i; ?>">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <br/>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">续重：</span><input type="text" placeholder="kg" name="weight_custom<?php echo $i.'_'.$geo_zone['geo_zone_id']; ?>_next_weight" value="<?php echo ${'weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_weight'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                    <p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">价格：</span><input type="text" name="weight_custom<?php echo $i.'_'.$geo_zone['geo_zone_id']; ?>_next_price" value="<?php echo ${'weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_price'}; ?>" class="form-control" style="width: 85%;" /></p>
                                                </div>
                                            </div>
                                            <?php } ?>
...
<script language="JavaScript">
    function addShipping(gid) {
        ...
        _html += '<br/>';
        _html += '<p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">续重：</span><input type="text" placeholder="kg" name="weight_custom'+_row+'_'+gid+'_next_weight" value="" class="form-control" style="width: 85%;" /></p>';
        _html += '<p style="float: left; width: 50%; padding-top: 5px;"><span style="float: left;">价格：</span><input type="text" name="weight_custom'+_row+'_'+gid+'_next_price" value="" class="form-control" style="width: 85%;" /></p>';
        _html += '</div>';
        _html += '</div>';
