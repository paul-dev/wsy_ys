    ...
    <div id="content" class="<?php echo $class; ?>" style="width: 80%; padding-left: 5px;"><?php echo $content_top; ?>
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><?php echo $product['name']; ?>
                ...
                <?php } ?>
                <?php if ($product['href_return']) { ?>
                  <br/>
                  <a href="<?php echo $product['href_return']; ?>" target="_blank"><small class="text-danger">此商品已申请退换货</small></a>
                <?php } ?>
              </td>
      ...
      <div class="buttons clearfix">
        <div class="pull-right">
            <?php if ($continue_pay) { ?>
            <a href="<?php echo $continue_pay; ?>" target="_blank" class="btn btn-primary">去付款</a>
            <?php } ?>
