...
class ControllerCheckoutSuccess extends Controller {
    ...
    public function pay() {
        ...
        if (isset($this->session->data['order_id']) && isset($this->request->get['order_id']) && $this->session->data['order_id'] == $this->request->get['order_id']) {
            $this->cart->clear();
        ...
        $data['heading_title'] = $this->language->get('heading_title_pay');
