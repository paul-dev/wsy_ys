...
class ModelSellerOrder extends Model {
	public function getOrder($order_id) {
		$order_query = $this->db->query("SELECT *, (SELECT c.fullname FROM " . DB_PREFIX . "customer c WHERE c.customer_id = o.customer_id) AS customer FROM `" . DB_PREFIX . "order` o WHERE o.store_id='".$this->customer->getShopId()."' AND o.order_id = '" . (int)$order_id . "'");
	...
	public function getOrders($data = array()) {
        ...
        $sql .= " AND o.store_id='".$this->customer->getShopId()."'";
	...
	public function getTotalOrders($data = array()) {
        ...
        $sql .= " AND store_id = '".$this->customer->getShopId()."'";
