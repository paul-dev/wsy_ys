<form class="form-horizontal">
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <div class="form-group required">
      ...
      <div class="form-group required">
          <label class="col-sm-2 control-label" for="input-payment-area">区县</label>
          <div class="col-sm-10">
              <input type="hidden" name="area" value="" />
              <select name="area_id" id="input-payment-area" class="form-control">
              </select>
          </div>
      </div>
    ...
    $('#collapse-payment-address select[name=\'city_id\']').on('change', function() {
        $.ajax({
            ...
            success: function(json) {
                ...
                if (json['name']) $('#collapse-payment-address input[name=\'city\']').val(json['name']);
                $('#collapse-payment-address select[name=\'area_id\']').html(html);
            },
            error: function(xhr, ajaxOptions, thrownError) {
                alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
            }
