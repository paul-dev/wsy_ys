...
class ControllerAccountAddress extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$replace = array(
                ...
                'telephone' => isset($result['custom_field'][1]) ? ', '.$result['custom_field'][1] : '',
	...
	protected function getForm() {
        ...
        }  elseif (!empty($address_info) && isset($address_info['city_id'])) {
        ...
        }  elseif (!empty($address_info) && isset($address_info['area_id'])) {
