...
class ControllerShippingWeight extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->deleteSetting('weight', 0);
		...
		foreach ($geo_zones as $geo_zone) {
            ...
            if (isset($this->request->post['weight_express_' . $geo_zone['geo_zone_id'] . '_first_weight'])) {
                ...
                $data['weight_express_' . $geo_zone['geo_zone_id'] . '_first_weight'] = $this->config->get('weight_express_' . $geo_zone['geo_zone_id'] . '_first_weight');
            }
            if (isset($this->request->post['weight_express_' . $geo_zone['geo_zone_id'] . '_first_price'])) {
                ...
                $data['weight_express_' . $geo_zone['geo_zone_id'] . '_first_price'] = $this->config->get('weight_express_' . $geo_zone['geo_zone_id'] . '_first_price');
            }
            if (isset($this->request->post['weight_express_' . $geo_zone['geo_zone_id'] . '_next_weight'])) {
                ...
                $data['weight_express_' . $geo_zone['geo_zone_id'] . '_next_weight'] = $this->config->get('weight_express_' . $geo_zone['geo_zone_id'] . '_next_weight');
            }
            if (isset($this->request->post['weight_express_' . $geo_zone['geo_zone_id'] . '_next_price'])) {
                ...
                $data['weight_express_' . $geo_zone['geo_zone_id'] . '_next_price'] = $this->config->get('weight_express_' . $geo_zone['geo_zone_id'] . '_next_price');
            }
            ...
            if (isset($this->request->post['weight_postage_' . $geo_zone['geo_zone_id'] . '_first_weight'])) {
                ...
                $data['weight_postage_' . $geo_zone['geo_zone_id'] . '_first_weight'] = $this->config->get('weight_postage_' . $geo_zone['geo_zone_id'] . '_first_weight');
            }
            if (isset($this->request->post['weight_express_' . $geo_zone['geo_zone_id'] . '_first_price'])) {
                ...
                $data['weight_postage_' . $geo_zone['geo_zone_id'] . '_first_price'] = $this->config->get('weight_postage_' . $geo_zone['geo_zone_id'] . '_first_price');
            }
            if (isset($this->request->post['weight_express_' . $geo_zone['geo_zone_id'] . '_next_weight'])) {
                ...
                $data['weight_postage_' . $geo_zone['geo_zone_id'] . '_next_weight'] = $this->config->get('weight_postage_' . $geo_zone['geo_zone_id'] . '_next_weight');
            }
            if (isset($this->request->post['weight_express_' . $geo_zone['geo_zone_id'] . '_next_price'])) {
                $data['weight_postage_' . $geo_zone['geo_zone_id'] . '_next_price'] = $this->request->post['weight_postage_' . $geo_zone['geo_zone_id'] . '_next_price'];
            } else {
                $data['weight_postage_' . $geo_zone['geo_zone_id'] . '_next_price'] = $this->config->get('weight_postage_' . $geo_zone['geo_zone_id'] . '_next_price');
            }
            ...
            if (isset($this->request->post['weight_ems_' . $geo_zone['geo_zone_id'] . '_first_weight'])) {
                ...
                $data['weight_ems_' . $geo_zone['geo_zone_id'] . '_first_weight'] = $this->config->get('weight_ems_' . $geo_zone['geo_zone_id'] . '_first_weight');
            }
            if (isset($this->request->post['weight_ems_' . $geo_zone['geo_zone_id'] . '_first_price'])) {
                ...
                $data['weight_ems_' . $geo_zone['geo_zone_id'] . '_first_price'] = $this->config->get('weight_ems_' . $geo_zone['geo_zone_id'] . '_first_price');
            }
            if (isset($this->request->post['weight_ems_' . $geo_zone['geo_zone_id'] . '_next_weight'])) {
                ...
                $data['weight_ems_' . $geo_zone['geo_zone_id'] . '_next_weight'] = $this->config->get('weight_ems_' . $geo_zone['geo_zone_id'] . '_next_weight');
            }
            if (isset($this->request->post['weight_ems_' . $geo_zone['geo_zone_id'] . '_next_price'])) {
                ...
                $data['weight_ems_' . $geo_zone['geo_zone_id'] . '_next_price'] = $this->config->get('weight_ems_' . $geo_zone['geo_zone_id'] . '_next_price');
            }
            ...
            for ($i=1;$i<=20;$i++) {
                if (isset($this->request->post['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_name'])) {
                    ...
                    $data['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_name'] = $this->config->get('weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_name');
                }
                if (isset($this->request->post['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_first_weight'])) {
                    ...
                    $data['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_first_weight'] = $this->config->get('weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_first_weight');
                }
                if (isset($this->request->post['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_first_price'])) {
                    ...
                    $data['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_first_price'] = $this->config->get('weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_first_price');
                }
                if (isset($this->request->post['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_weight'])) {
                    ...
                    $data['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_weight'] = $this->config->get('weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_weight');
                }
                if (isset($this->request->post['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_price'])) {
                    ...
                    $data['weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_price'] = $this->config->get('weight_custom'.$i.'_' . $geo_zone['geo_zone_id'] . '_next_price');
                }
            }
