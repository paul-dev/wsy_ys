...
class ControllerCommonColumnRight extends Controller {
	public function index($_settings = array()) {
        ...
        $data['custom_class'] = 'col-sm-2';
        if ($route == 'product/product' && isset($_settings['productStoreId'])) {
            $data['modules'][] = $this->load->controller('module/shop_right', $_settings);
            $data['custom_class'] = 'col-sm-3';
        }
