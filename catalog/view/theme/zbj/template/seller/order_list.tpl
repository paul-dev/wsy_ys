                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table order_table">
                                    ...
                                    <tr style="border-top:1px solid #ccc">
                                        <th style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);$('input[name^=\'selected\']:first').trigger('change');" /></th>
                                    ...
                                    <tr>
                                        <td class="text-center" style="background-color: #e8e8e8;border-right:none"><?php if (in_array($order['order_id'], $selected)) { ?>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td class="text-left">
                                            <a href="<?php echo $product['href']; ?>" target="_blank" style="float: left;">
            ...
            <script type="text/javascript"><!--
                $('input[name=\'filter_customer\']').autocomplete({
                    'source': function(request, response) {
                        $.ajax({
                            url: 'index.php?route=seller/customer/autocomplete&filter_name=' +  encodeURIComponent(request),
                            dataType: 'json',
