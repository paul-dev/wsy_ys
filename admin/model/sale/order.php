...
class ModelSaleOrder extends Model {
	...
	public function getOrderProducts($order_id, $is_parent = false) {
		if ($is_parent) {
            $sql = "SELECT op.* FROM `" . DB_PREFIX . "order` o INNER JOIN " . DB_PREFIX . "order_product op ON o.order_id=op.order_id WHERE (o.order_id = '" . (int)$order_id . "' OR o.parent_id = '".(int)$order_id."')";
        } else {
