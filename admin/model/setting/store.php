...
class ModelSettingStore extends Model {
	...
	public function editStore($store_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "store SET status = '".(int)$data['config_status']."', name = '" . $this->db->escape($data['config_name']) . "', `url` = '" . $this->db->escape($data['config_url']) . "', `ssl` = '" . $this->db->escape($data['config_ssl']) . "' WHERE store_id = '" . (int)$store_id . "'");
