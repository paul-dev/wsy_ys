                    ...
                    <div class="panel-body">
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
                            <ul class="nav nav-tabs">
                                ...
                                <li<?php if (!$is_seller) echo ' style="display: none;"'; ?>><a href="#tab-store" data-toggle="tab"><?php echo $tab_store; ?></a></li>
                                ...
                                <li<?php if (!$is_seller) echo ' style="display: none;"'; ?>><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
                                <li style="display: none;"><a href="#tab-server" data-toggle="tab"><?php echo $tab_server; ?></a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab-cert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <label class="radio-inline">
                                                <input type="checkbox" name="config_cert_approve" value="1" />
                                                我已经阅读并同意<<珠宝街商家服务协议>>
                                            </label>
                                        </div>
                                    </div>
