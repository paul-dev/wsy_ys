            ...
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="config_key" value="<?php echo $config_key; ?>" placeholder="<?php echo $entry_key; ?>" id="input-key" class="form-control" />
                        <?php if ($error_key) { ?>
              ...
              <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <select name="config_status" id="input-status" class="form-control">
            ...
            <div class="tab-pane" id="tab-server">
              ...
              <div class="tab-pane" id="tab-cert">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <?php if ($config_cert_approve == 9) { ?>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="1" /> 等待
                          </label>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="9" checked="checked" /> 通过
                          </label>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="3" /> 退回
                          </label>
                          <?php } elseif ($config_cert_approve == 3) { ?>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="1" /> 等待
                          </label>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="9" /> 通过
                          </label>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="3" checked="checked" /> 退回
                          </label>
                          <?php } else { ?>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="1" checked="checked" /> 等待
                          </label>
                          <label class="radio-inline">
                              <input type="radio" name="config_cert_approve" value="9" /> 通过
                          </label>
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-store-margin">保证金额</label>
                      <div class="col-sm-10">
                          <div class="row">
                              <div class="col-sm-6">
                                  <input type="text" name="config_store_margin" value="<?php echo $config_store_margin; ?>" placeholder="保证金额" id="input-store-margin" class="form-control" />
                              </div>
                          </div>
                          <?php if ($error_store_margin) { ?>
                          <div class="text-danger"><?php echo $error_store_margin; ?></div>
                          <?php } ?>
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-cert-comment">退回说明</label>
                      <div class="col-sm-6">
                          <textarea name="config_cert_comment" rows="5" placeholder="审核失败原因" id="input-cert-comment" class="form-control"><?php echo $config_cert_comment; ?></textarea>
                      </div>
                  </div>
              </div>
