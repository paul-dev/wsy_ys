<script src="catalog/view/theme/zbj/js/uploadify/jquery.uploadify.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/zbj/js/uploadify/uploadify.css">
<div class="">
  <div class="">
...
<script type="text/javascript">
    ...
    $(function() {
        $('#file_upload').uploadify({
            ...
            'swf'      : 'catalog/view/theme/zbj/js/uploadify/uploadify.swf',
            'uploader' : 'index.php?route=seller/filemanager/upload&directory=<?php echo $directory; ?>',
            'cancelImg': 'catalog/view/theme/zbj/js/uploadify/uploadify-cancel.png',
