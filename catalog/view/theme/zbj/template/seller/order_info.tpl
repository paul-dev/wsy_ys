        ...
        <div id="content" class="<?php echo $class; ?>" style="width: 80%; padding-left: 5px;"><?php echo $content_top; ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab-history">
                                <div id="history"></div>
                                <br />
                                <fieldset<?php if (!in_array((int)$order_status_id, array(2,15))) echo ' style="display:none;"'; ?>>
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group required">
                                            <label class="col-sm-2 control-label" for="input-order-status">更新状态</label>
                                            <div class="col-sm-10">
                                                <select name="order_status_id" id="input-order-status" class="form-control" style="width: 15%;">
                                        ...
                                        <!--<input type="hidden" name="order_status_id" id="input-order-status" value="3" />-->
                                        <div class="form-group" style="display: none;">
                                            <label class="col-sm-2 control-label" for="input-notify"><?php echo $entry_notify; ?></label>
                                            <div class="col-sm-10">
                                                <input type="checkbox" name="notify" checked="checked" value="1" id="input-notify" />
                                            </div>
                                        </div>
                                        <div class="form-group required">
                                            <label class="col-sm-2 control-label" for="input-delivery-name">快递名称</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="delivery_name" placeholder="快递公司名称" id="input-delivery-name" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="form-group required">
                                            <label class="col-sm-2 control-label" for="input-delivery-number"><span data-toggle="tooltip" title="如更新状态为等待发货时，请填写预计发货时间">快递单号</span></label>
                                            <div class="col-sm-10">
                                                <input type="text" name="delivery_number" placeholder="快递运单号" id="input-delivery-number" class="form-control" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" for="input-comment"><?php echo $entry_comment; ?></label>
                                            <div class="col-sm-10">
                                                <textarea name="comment" placeholder="快递查询地址等" rows="8" id="input-comment" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="text-right">
                                        <button id="button-history" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> 确认操作</button>
                                    </div>
                                </fieldset>
                            </div>
                            <?php if ($payment_action) { ?>
            ...
            <script type="text/javascript"><!--
                ...
                $(document).delegate('#button-reward-add', 'click', function() {
                    $.ajax({
                        url: 'index.php?route=seller/order/addreward&order_id=<?php echo $order_id; ?>',
                        type: 'post',
                        dataType: 'json',
                        beforeSend: function() {
                ...
                $(document).delegate('#button-reward-remove', 'click', function() {
                    $.ajax({
                        url: 'index.php?route=seller/order/removereward&order_id=<?php echo $order_id; ?>',
                        type: 'post',
                        dataType: 'json',
                        beforeSend: function() {
                ...
                $('#history').load('index.php?route=seller/order/history&order_id=<?php echo $order_id; ?>');
                ...
                $('#button-history').on('click', function() {
                    ...
                    $.ajax({
                        url: 'index.php?route=seller/order/delivery&order_id=<?php echo $order_id; ?>',
                        type: 'post',
                        dataType: 'json',
                        data: 'status='+encodeURIComponent($('select[name=\'order_status_id\']').val())+'&name='+ encodeURIComponent($('input[name=\'delivery_name\']').val()) +'&number=' + encodeURIComponent($('input[name=\'delivery_number\']').val()) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
                        beforeSend: function() {
                        ...
                        success: function(json) {
                            ...
                            if (json['success']) {
                                ...
                                if ($('select[name=\'order_status_id\'] option:selected').val() == '1') {
                                    $('#order-status').html('卖家已发货');
                                    $('#history').parent().find('fieldset').hide();
                                } else {
                                    $('#order-status').html('等待卖家发货');
                                    $('select[name=\'order_status_id\'] option:selected').remove();
