...
if ($thumb) {
?>
<div class="contn_wrap" style="text-align: center; margin-bottom: 10px; width: auto;">
    <a class="" href="<?php echo $link; ?>" target="_blank" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" /></a>
</div>
<?php } else { ?>
