      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-template">模板</label>
                <div class="col-sm-10">
                    <input type="text" name="template" value="<?php echo $template; ?>" placeholder="模板" id="input-template" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-inner">内嵌</label>
                <div class="col-sm-10">
                    <input type="checkbox" name="inner" value="1" <?php if ($inner) echo 'checked="checked"'; ?> id="input-inner" class="form-control" />
                </div>
            </div>
          <div class="form-group">
