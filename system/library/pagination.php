...
class Pagination {
	...
	public function render() {
		...
		if ($page > 1) {
			$output .= '<li><a href="' . str_replace('{page}', 1, $this->url) . '" style="color: #ff8cb5;">' . $this->text_first . '</a></li>';
			$output .= '<li><a href="' . str_replace('{page}', $page - 1, $this->url) . '" style="color: #ff8cb5;">' . $this->text_prev . '</a></li>';
		}
