	...
	public function items() {
		...
		foreach ($results as $result) {
			...
			foreach ($product_specials  as $product_special) {
				if (($product_special['date_start'] == '0000-00-00 00:00:00' || $product_special['date_start'] < date('Y-m-d H:i:s')) && ($product_special['date_end'] == '0000-00-00 00:00:00' || $product_special['date_end'] > date('Y-m-d H:i:s'))) {
