<div class="list-group">
  ...
  <?php if ($logged) { ?>
    <a href="<?php echo $url_seller; ?>" class="list-group-item"><?php echo $text_seller; ?></a> <a href="<?php echo $edit; ?>" class="list-group-item"><?php echo $text_edit; ?></a> <a href="<?php echo $password; ?>" class="list-group-item"><?php echo $text_password; ?></a>
