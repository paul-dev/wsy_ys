        ...
        <div id="content" class="<?php echo $class; ?>" style="width: 80%; padding-left: 5px;"><?php echo $content_top; ?>
                        ...
                        <div class="well">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <button type="button" id="button-filter" class="btn btn-primary pull-right" style="margin-top: 100px;"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="page-header" style="margin: 0px;">
                                    <div class="container-fluid" style="padding-left: 0px; padding-right: 0px;">
                                        <div class="pull-left" style="width: 50%;">
                                            <select name="action" class="form-control" style="width: 25%; margin-bottom: 5px; float: left; margin-right: 5px;">
                                                <option value="on_sale">批量上架</option>
                                                <option value="un_sale">批量下架</option>
                                            </select>
                                            <a href="javascript:void(0);" id="button-mess-action" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                        </div>
            ...
            <script type="text/javascript"><!--
                $('#button-filter').on('click', function() {
                    var url = 'index.php?route=seller/product';
                ...
                $('#button-mess-action').on('click', function(){
                    if (confirm('<?php echo $text_confirm; ?>')) {
                        var _action = '<?php echo $mess; ?>';
                        _action = _action.replace('&amp;', '&');
                        $('#form-product').attr('action', _action);
                        $('#form-product').submit();
                    }
