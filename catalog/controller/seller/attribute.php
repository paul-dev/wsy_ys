...
class ControllerSellerAttribute extends Controller {
	...
	public function add() {die('access denied.');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('seller/attribute', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {die('access denied.');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('seller/attribute', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('seller/attribute/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('seller/attribute/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['attributes'][] = array(
				...
				'edit'            => $this->url->link('seller/attribute/edit', 'token=' . $this->session->data['token'] . '&attribute_id=' . $result['attribute_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('seller/attribute', 'token=' . $this->session->data['token'] . '&sort=ad.name' . $url, 'SSL');
		$data['sort_attribute_group'] = $this->url->link('seller/attribute', 'token=' . $this->session->data['token'] . '&sort=attribute_group' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('seller/attribute', 'token=' . $this->session->data['token'] . '&sort=a.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('seller/attribute', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('seller/attribute_list.tpl', $data));
	}
	...
	protected function getForm() {die('access denied.');
		...
		if (!isset($this->request->get['attribute_id'])) {
			$data['action'] = $this->url->link('seller/attribute/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('seller/attribute/edit', 'token=' . $this->session->data['token'] . '&attribute_id=' . $this->request->get['attribute_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('seller/attribute', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('seller/attribute_form.tpl', $data));
	}

	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'seller/attribute')) {
